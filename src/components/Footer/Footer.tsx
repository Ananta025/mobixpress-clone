...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-t-gray-200 mt-12 text-sm text-gray-700 pt-10">
      <div className="max-w-7xl mx-auto px-12 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* 📱 Brand & about */}
        <div className="space-y-3">
          <div className="flex items-center space-x-2">
            <Image src="/logo.png" alt="MobiXpress" width={200} height={200} />
          </div>
          ...
          <div className="flex items-center space-x-2 mt-2">
            ...
            <button className="bg-green-600 text-white text-sm px-2.5 py-1 rounded flex items-center">
        ...
        <div>
          ...
          <div className="flex items-start space-x-2 mb-3">
            <span className="bg-red-600 text-white rounded-full p-1 text-xs mt-0.5">📍</span>
            <p className="text-sm">
      ...
      <div className="bg-[#1e1e1e] py-4 flex flex-col md:flex-row items-center justify-between text-sm px-40">
