export default function TopBanner() {
  return (
    <div className="bg-red-600 text-white text-center py-2 sm:py-3 text-xs sm:text-sm font-medium px-2">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2">
        <span className="bg-white px-2 sm:px-3 py-0.5 sm:py-1 font-medium text-black text-sm sm:text-lg rounded">
